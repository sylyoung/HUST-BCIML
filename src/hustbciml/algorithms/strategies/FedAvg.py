...
# Original authors:    Brendan McMahan, Eider Moore, Daniel Ramage, Seth Hampson, Blaise Agüera y Arcas (2017) — "Communication-Efficient Learning of Deep Networks from Decentralized Data", Proc. AISTATS
