window.BENCHMARK = {
    ...
    "datasets": [
      {
        ...
        "chance": "50%",
        "trials": "288 / session",
        "role": "Left hand versus right hand (two-class, chance 50%) in every table, including the privacy-preserving family. The original dataset is four-class (left hand, right hand, both feet, and tongue). The benchmark uses its two-class left/right subset throughout, and the four-class variant remains available in the code."
      },
      {
        "name": "BNCI2014002",
        "subjects": 14,
  ...
  "library": {
    ...
    "tagline": "Every approach is composed of the same modular stages, i.e., an aligner, an augmenter and a backbone, trained under a single learning objective. A controlled comparison varies one stage and fixes the rest, so that any change in the accuracy is attributable to that stage alone.",
    "pipeline": [
      "Aligner",
      "Augmenter",
      "Backbone"
